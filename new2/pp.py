...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div style="max-height: 500px; overflow-y: auto; border: 1px solid #ccc; padding: 10px; border-radius: 5px;">
              ...
              <div class="accordion-item">
                ...
                <div id="collapse{{ block.index }}" class="accordion-collapse collapse" aria-labelledby="heading{{ block.index }}" data-bs-parent="#blockchainAccordion">
                  <div class="accordion-body">
                    {# Check if block.data is a string by checking its class name #}
                    {% if block.data.__class__.__name__ == 'str' %}
                      <p>{{ block.data }}</p>
                    {% else %}
    ...
    <script>
      ...
      // Initialize the Chart.js chart for sensor data with multiple y-axes
      ...
      var sensorChart = new Chart(ctx, {
          ...
          data: {
              labels: [],
              datasets: [
                  { label: 'T_in (°C)', borderColor: 'blue', fill: false, data: [], yAxisID: 'y' },
                  { label: 'T_out (°C)', borderColor: 'red', fill: false, data: [], yAxisID: 'y' },
                  { label: 'RPM', borderColor: 'green', fill: false, data: [], yAxisID: 'y1' },
                  { label: 'Vibration (mm/s)', borderColor: 'orange', fill: false, data: [], yAxisID: 'y' },
                  { label: 'Pressure Ratio', borderColor: 'purple', fill: false, data: [], yAxisID: 'y' },
                  { label: 'Surge Margin (%)', borderColor: 'brown', fill: false, data: [], yAxisID: 'y' }
              ]
          },
          options: {
              responsive: true,
              ...
              scales: {
                ...
                y: {
                  ...
                  display: true,
                  position: 'left',
                  title: { display: true, text: 'Temperature, Vibration, Pressure, Surge Margin' }
                },
                y1: {
                  type: 'linear',
                  display: true,
